...
public class AuthenticationServiceTest {
    ...
    public void testRegister() {
        RegisterRequest request = new RegisterRequest("john", "John", "Doe", "john@example.com", "password", "password");
    ...
    public void testLogin() {
        ...
        User user = new User("john", "John", "Doe", "john@example.com", "encodedPassword", Role.USER);
